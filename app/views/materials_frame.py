...
class MaterialsFrame(ctk.CTkFrame):
    def __init__(self, master=None, viewmodel=None, texts=None, app_instance=None, **kwargs):
        ...
        self.materials_output_label = ctk.CTkLabel(
            self, text=self.texts.get("processed_history", "Processed History"), anchor="w"
        )
    ...
    def update_texts(self, new_texts: dict):
        ...
        self.materials_output_label.configure(text=self.texts.get("processed_history", "Processed History"))
